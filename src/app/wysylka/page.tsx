					...
					<div className="grid gap-6 md:grid-cols-2">
						<article className="rounded-2xl border border-border bg-card p-6">
							...
							<p className="mt-2 text-foreground/80">
								Wszystkie przesyłki są ubezpieczone. Jeśli przedmiot dotrze uszkodzony — zwracamy
								pieniądze lub obniżamy cenę. Wymiana jest niemożliwa, bo każdy antyk to unikat.
								Szczegóły procedury:{" "}
								<Link
									href="/reklamacje"
			...
			<Section spacing="md">
				<Container size="md">
					...
					<div className="mt-6 space-y-4 rounded-2xl border border-border bg-card p-6 text-foreground/80 leading-relaxed md:p-8">
						...
						<p>
							Antyki to rzeczy używane. Przed zakupem zapoznajesz się z opisem stanu przedmiotu i
							akceptujesz go w koszyku — opisane ślady użytkowania nie są podstawą reklamacji.
						</p>
						<p>
							Odpowiadasz finansowo za zmniejszenie wartości przedmiotu wynikłe z korzystania ponad
							to, co konieczne do sprawdzenia (art. 34 ust. 4 UPK). Dla unikatów oznacza to, że
							ekspozycja, używanie czy próby renowacji mogą zostać wycenione i odjęte od zwrotu.
						</p>
						<p>
